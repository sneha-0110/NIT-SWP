...
function IT({ branch }) {
    return (
        <div className="branch__name">
            ...
            <li className="branch__name__listItem">
                    <h2 className="branch__name__software__heading">StarUML.</h2>
                    <p>
                ...
                <li className="branch__name__listItem">
                    <h2 className="branch__name__software__heading">Cisco Network Assistant</h2>
                    <p>
                ...
                <li className="branch__name__listItem">
                    <h2 className="branch__name__software__heading">Weka</h2>
                    <p>
